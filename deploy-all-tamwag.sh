...
hugo --cleanDestinationDir -e $e -s ~/projects/southernworker-nyudlts/;
...
hugo --cleanDestinationDir -e $e -s ~/projects/palante-nyudlts/;
...
hugo --cleanDestinationDir -e $e -s ~/projects/freedom-nyudlts/;
...
hugo --cleanDestinationDir -e $e -s ~/projects/themasses-nyudlts/;
